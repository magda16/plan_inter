                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li><a data-toggle="tooltip" data-placement="top" title="Lista Usuarios" href="lista_usuarios" ><i class="fa fa-list"></i></a>
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  ...
                  <br />
                    ...
                    <form id="form_usuario" name="form_usuario" method="POST" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control" id="nivel" name="nivel">
                            ...
                            <option value="Gestro Empresarial">Gestor Empresarial</option>
                            <option value="Gestor Empleo Plan">Gestor Empleo Plan</option>
                            <option value="Gestor Empleo">Gestor Empleo</option>
                      ...
                      <div class="form-group" id="div_em" name="div_em">
