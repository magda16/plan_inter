              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <br />
                      ...
                      <tbody>
                        ...
                        foreach($result as $lista_oferta){
                              ...
                              if($editar=="si"){
                                ...
                                echo "<a class='btn btn-info' onclick='editar_oferta(".$lista_oferta['id_oferta'].")' data-toggle='tooltip' data-placement='top' title='Editar Oferta'><i class='fa fa-edit'></i></a>";
                                echo "<a class='btn btn-danger' onclick='eliminar_oferta(".$lista_oferta['id_oferta'].")' data-toggle='tooltip' data-placement='top' title='Eliminar Oferta'><i class='fa fa-trash-o'></i></a>";
                              }else{
                                echo "<a class='btn btn-success' onclick='mostrar_oferta(".$lista_oferta['id_oferta'].")' data-toggle='tooltip' data-placement='top' title='Mostrar Oferta'><i class='fa fa-eye'></i></a>";
                                echo "<a class='btn btn-info' onclick='editar_oferta(".$lista_oferta['id_oferta'].")' data-toggle='tooltip' data-placement='top' title='Editar Oferta'><i class='fa fa-edit'></i></a>";
                              }
                    ...
                    <form id="from_editar_oferta" name="from_editar_oferta" action="editar_oferta.php" method="POST">
