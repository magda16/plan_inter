                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li><a data-toggle="tooltip" data-placement="top" title="Agregar Empresa" href="ingreso_empresa.php"><i class="fa fa-plus-circle"></i></a>
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  ...
                  <br />
                      ...
                      <tbody>
                        ...
                        foreach($result as $lista_empresa){
                              ...
                              if($editar=="si"){
                                ...
                                echo "<a class='btn btn-info' onclick='editar_empresa(".$lista_empresa['id_empresa'].")' data-toggle='tooltip' data-placement='top' title='Editar Empresa'><i class='fa fa-edit'></i></a>";
                                echo "<a class='btn btn-danger' onclick='eliminar_empresa(".$lista_empresa['id_empresa'].")' data-toggle='tooltip' data-placement='top' title='Eliminar Empresa'><i class='fa fa-trash-o'></i></a>";
                              }else{
                                echo "<a class='btn btn-success' onclick='mostrar_empresa(".$lista_empresa['id_empresa'].")' data-toggle='tooltip' data-placement='top' title='Mostrar Empresa'><i class='fa fa-eye'></i></a>";
                                echo "<a class='btn btn-info' onclick='editar_empresa(".$lista_empresa['id_empresa'].")' data-toggle='tooltip' data-placement='top' title='Editar Empresa'><i class='fa fa-edit'></i></a>";
                              }
                    ...
                    <form id="from_editar_empresa" name="from_editar_empresa" action="editar_empresa.php" method="POST">
