                  ...
                  <br />
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        $contador=1;
                        $stmt= $pdo->prepare("SELECT d.id_demandante, d.nombre_apellido, m.nombre, d.ultimo_grado, d.habilidades_deztrezas FROM demandantes AS d INNER JOIN municipios AS m On (d.municipio=m.id_municipio) ORDER BY d.nombre_apellido");
                        $stmt->execute();
                        ...
                        foreach($result as $lista_demandantes){
                              ...
                              echo "<td><a class='btn btn-success' onclick='ver_oferta(".$lista_demandantes['id_demandante'].")' data-toggle='tooltip' data-placement='top' title='Ver Oferta'><i class='fa fa-eye'></i> Ver Oferta</a>
                                          </td>";
                              echo "</tr>";
                              $contador++;
                          }
